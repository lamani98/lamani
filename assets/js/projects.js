...
(() => {
  ...
  const CONFIG = {
    ...
    PROJECT_IMAGES: {
      'yellow-k': [
        { carousel: "../assets/img/yellow-k/IMG_4108-960.webp",  lightbox: "../assets/img/yellow-k/IMG_4108-1920.webp" },
        { carousel: "../assets/img/yellow-k/IMG_0938-960.webp",  lightbox: "../assets/img/yellow-k/IMG_0938-1920.webp" },
        { carousel: "../assets/img/yellow-k/IMG_0052-960.webp",  lightbox: "../assets/img/yellow-k/IMG_0052-1920.webp" },
        { carousel: "../assets/img/yellow-k/IMG_4101-960.webp",  lightbox: "../assets/img/yellow-k/IMG_4101-1920.webp" },
        { carousel: "../assets/img/yellow-k/IMG_4090-960.webp",  lightbox: "../assets/img/yellow-k/IMG_4090-1920.webp" },
        { carousel: "../assets/img/yellow-k/IMG_4098-960.webp",  lightbox: "../assets/img/yellow-k/IMG_4098-1920.webp" },
        { carousel: "../assets/img/yellow-k/IMG_0977-960.webp",  lightbox: "../assets/img/yellow-k/IMG_0977-1920.webp" },
        { carousel: "../assets/img/yellow-k/IMG_0959-960.webp",  lightbox: "../assets/img/yellow-k/IMG_0959-1920.webp" },
        { carousel: "../assets/img/yellow-k/IMG_1004-960.webp",  lightbox: "../assets/img/yellow-k/IMG_1004-1920.webp" },
        { carousel: "../assets/img/yellow-k/IMG_4097-960.webp",  lightbox: "../assets/img/yellow-k/IMG_4097-1920.webp" },
        { carousel: "../assets/img/yellow-k/IMG_8954-960.webp",  lightbox: "../assets/img/yellow-k/IMG_8954-1920.webp" },
        { carousel: "../assets/img/yellow-k/IMG_8960-960.webp",  lightbox: "../assets/img/yellow-k/IMG_8960-1920.webp" },
      ],
      'academia': [
        { carousel: "../assets/img/academia/mg-smartfit-pocos-de-caldas/smartfit-fachada2.webp", lightbox: "../assets/img/academia/mg-smartfit-pocos-de-caldas/smartfit-fachada2.webp" },
        { carousel: "../assets/img/academia/mg-smartfit-pocos-de-caldas/smartfit-fachada.webp", lightbox: "../assets/img/academia/mg-smartfit-pocos-de-caldas/smartfit-fachada.webp" },
        { carousel: "../assets/img/academia/mg-smartfit-pocos-de-caldas/smartfit-pos-obra-fachada3-960.webp", lightbox: "../assets/img/academia/mg-smartfit-pocos-de-caldas/smartfit-pos-obra-fachada3-1920.webp" },
        { carousel: "../assets/img/academia/mg-smartfit-pocos-de-caldas/smartfit-pos-obra-salao2-960.webp",  lightbox: "../assets/img/academia/mg-smartfit-pocos-de-caldas/smartfit-pos-obra-salao2-1920.webp" },
        { carousel: "../assets/img/academia/mg-smartfit-pocos-de-caldas/smartfit-pos-obra-cardio-960.webp",  lightbox: "../assets/img/academia/mg-smartfit-pocos-de-caldas/smartfit-pos-obra-cardio-1920.webp" },
        { carousel: "../assets/img/academia/mg-smartfit-pocos-de-caldas/smartfit-pos-obra-salagrupo-960.webp", lightbox: "../assets/img/academia/mg-smartfit-pocos-de-caldas/smartfit-pos-obra-salagrupo-1920.webp" },
        { carousel: "../assets/img/academia/mg-smartfit-pocos-de-caldas/smartfit-project.webp", lightbox: "../assets/img/academia/mg-smartfit-pocos-de-caldas/smartfit-project.webp" },
      ],
      'estudio': [
        { carousel: "../assets/img/studio-mina/tv-960.webp",   lightbox: "../assets/img/studio-mina/tv-1920.webp" },
        { carousel: "../assets/img/studio-mina/cama-960.webp", lightbox: "../assets/img/studio-mina/cama-1920.webp" },
        { carousel: "../assets/img/studio-mina/cama2.webp", lightbox: "../assets/img/studio-mina/cama2.webp" },
        { carousel: "../assets/img/studio-mina/cama3.webp", lightbox: "../assets/img/studio-mina/cama3.webp" },
        { carousel: "../assets/img/studio-mina/guarda-roupas2.webp", lightbox: "../assets/img/studio-mina/guarda-roupas2.webp" },
        { carousel: "../assets/img/studio-mina/guarda-roupas.webp", lightbox: "../assets/img/studio-mina/guarda-roupas.webp" },
        { carousel: "../assets/img/studio-mina/revestimento.webp", lightbox: "../assets/img/studio-mina/revestimento.webp" },
      ],
    },
  };
  ...
  function cacheDOM() {
    ...
    dom.menuTrigger = qs('.menu-trigger');
  ...
  function setupMenuBehavior() {
    ...
    addListener(dom.menuToggle, 'change', () => {
      if (dom.menuTrigger) dom.menuTrigger.setAttribute('aria-expanded', String(dom.menuToggle.checked));
    });
  }
  ...
  function updateHeaderVisibility(currentY) {
    ...
    const heroThreshold = dom.hero ? dom.hero.offsetHeight * 0.8 : 0;
    dom.header.classList.toggle('header--scrolled', currentY >= heroThreshold);
  }
  ...
  /* ------------------------------------------------------------------------
     ...
     ------------------------------------------------------------------------ */
  function buildSlideNode(label, toneClass, carouselUrl, lightboxUrl) {
    const slide = document.createElement('div');
    slide.className = 'croqui-slide reveal';
    slide.dataset.url = lightboxUrl || carouselUrl;
    slide.dataset.label = label;

    const tone = document.createElement('div');
    tone.className = `tone ${toneClass} ratio-4-5 banner_default_style`;
    tone.style.backgroundImage = `url('${carouselUrl}')`;
  ...
  function setupCroquisCarousel() {
    ...
    const projectName = document.body.dataset.project || 'yellow-k';
    const images = CONFIG.PROJECT_IMAGES[projectName] || CONFIG.PROJECT_IMAGES['yellow-k'];
    const slides = images.map((img, i) => ({
      label: `Imagem ${String(i + 1).padStart(2, '0')}`,
      toneClass: CONFIG.CROQUI_TONES[i % CONFIG.CROQUI_TONES.length],
      url: img.carousel,
      lightboxUrl: img.lightbox,
      index: i,
    }));
    ...
    slides.forEach(s => viewport.appendChild(buildSlideNode(s.label, s.toneClass, s.url, s.lightboxUrl)));
    ...
    moreBtn.textContent = `Ver todas as imagens (${slides.length})`;
    ...
    slides.forEach(s => {
      const item = buildSlideNode(s.label, s.toneClass, s.url, s.lightboxUrl);
...
const mensagens = [
    ...
    "Como você imagina o seu espaço ideal?",
    "Projetos que acolhem começam com uma boa conversa. vamos lá?",
    "Conte-nos o que você imagina. O projeto começa a partir daí.",
    "Seu próximo espaço começa com as escolhas certas.",
];

const elemento = document.querySelector(".mensagem_contato");

const mensagemAleatoria = mensagens[Math.floor(Math.random() * mensagens.length)];

elemento.textContent = mensagemAleatoria;